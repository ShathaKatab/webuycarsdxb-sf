...
class DealAdmin extends AbstractAdmin
{
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        ...
        $datagridMapper->add('name', null, ['label' => 'Name'])
            ...
            ->add('createdAt', 'doctrine_orm_date_range', AdminDateRange::getDoctrineOrmDateRange('Deal Created Date Range'))
            ->add('appointment.dateBooked', 'doctrine_orm_date_range', AdminDateRange::getDoctrineOrmDateRange('Appointment Booked Date Range'));
    }
