 ...
 */
class Version20170415184832 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, vehicle_make_id INT DEFAULT NULL, vehicle_model_id INT DEFAULT NULL, vehicle_model_type_id INT DEFAULT NULL, branch_timing INT DEFAULT NULL, name VARCHAR(100) NOT NULL, mobile_number VARCHAR(15) NOT NULL, email_address VARCHAR(100) NOT NULL, nationality VARCHAR(2) DEFAULT NULL, vehicle_year SMALLINT NOT NULL, vehicle_transmission VARCHAR(15) NOT NULL, vehicle_trim VARCHAR(100) NOT NULL, vehicle_mileage BIGINT NOT NULL, vehicle_specifications VARCHAR(10) NOT NULL, vehicle_body_condition VARCHAR(30) NOT NULL, date_booked DATE NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_FE38F8445E237E06 (name), INDEX IDX_FE38F844D0CC2E84 (vehicle_make_id), INDEX IDX_FE38F844A467B873 (vehicle_model_id), INDEX IDX_FE38F844F20EB8A8 (vehicle_model_type_id), INDEX IDX_FE38F844E6D0E3BE (branch_timing), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_FE38F844D0CC2E84 FOREIGN KEY (vehicle_make_id) REFERENCES vehicle_make (id) ON DELETE SET NULL');
