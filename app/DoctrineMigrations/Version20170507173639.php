 ...
 */
class Version20170507173639 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE crawler_classifieds_model_type ADD CONSTRAINT FK_152590297975B7E7 FOREIGN KEY (model_id) REFERENCES vehicle_model (id)');
    }
